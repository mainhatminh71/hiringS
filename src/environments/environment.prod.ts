...
export const environment = {
    production: true,
    firebase: {
      apiKey: environmentSecret.firebase.apiKey || 'FIREBASE_API_KEY',
      ...
      firebaseEmail: environmentSecret.firebase.firebaseEmail || 'FIREBASE_EMAIL',
      firebasePassword: environmentSecret.firebase.firebasePassword || 'FIREBASE_PASSWORD'
    }
  };
